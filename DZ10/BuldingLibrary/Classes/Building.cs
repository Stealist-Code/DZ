...
namespace BuildingLibrary.Classes
{
    public class Building
    {
        private static long increasingNumber = 1;
        public long Id { get; private set; }
        public decimal Height { get; private set; }
        public int NumbFloors { get; private set; }
        public int NumbFlat { get; private set; }
        public int NumbEntrance { get; private set; }

        internal Building(decimal height, int numbfloors, int numbflat, int numbentrance)
        {
            Id = NumberChange();
            Height = height;
        ...
        internal Building(long id, decimal height, int numbfloors, int numbflat, int numbentrance)
        {
            Id = id;
            Height = height;
            NumbFloors = numbfloors;
        ...
        private static long NumberChange()
        {
